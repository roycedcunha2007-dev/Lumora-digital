        ...
        >
          {pricing.map((plan) => (
            <motion.div
              ...
              className={cn(
                "group relative flex flex-col overflow-hidden rounded-[2rem] p-8",
                plan.highlight
                  ? "gradient-border bg-gradient-to-b from-white/[0.08] to-white/[0.02] lg:-translate-y-4 lg:scale-[1.03]"
            ...
            >
              {plan.highlight && (
                <>
                  ...
                  <span className="absolute right-6 top-6 inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-electric-500 to-purple-500 px-3 py-1 text-[11px] font-semibold text-white">
