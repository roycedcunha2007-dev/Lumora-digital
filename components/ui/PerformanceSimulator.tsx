...
export default function PerformanceSimulator() {
  ...
  return (
    <div className="w-full rounded-[2.5rem] border border-white/[0.08] bg-[#08080c]/85 p-6 sm:p-10 shadow-2xl backdrop-blur-2xl">
      ...
      <div className="my-8">
        ...
        <div className="relative flex items-center">
          <input
            ...
            className="w-full h-3 bg-navy-950 rounded-lg appearance-none cursor-pointer accent-blue-500 border border-white/10 focus:outline-none"
          />
        </div>
        <div className="flex justify-between text-[10px] font-mono text-white/40 mt-2">
          ...
          <span className="text-blue-400 font-bold">100% (Lumora Gold Standard)</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
        ...
        <motion.div
          ...
          className="rounded-2xl border border-white/[0.08] bg-[#07080c]/60 p-5 text-center transition-colors hover:border-blue-500/30"
        >
          ...
          <span className="font-display text-3xl sm:text-4xl font-bold text-white">
            {fps} <span className="text-xs text-blue-400">FPS</span>
          </span>
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-[#07080c]/60 p-5 text-center transition-colors hover:border-blue-500/30">
          <div className="flex items-center justify-center gap-1.5 text-xs text-white/50 mb-2">
            <Gauge className="h-3.5 w-3.5 text-blue-400" />
            <span>Lighthouse Score</span>
          </div>
          <span className="font-display text-3xl sm:text-4xl font-bold text-white">
            {lighthouse} <span className="text-xs text-blue-400">/ 100</span>
          </span>
          <span className="block text-[10px] text-white/40 mt-1">
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-[#07080c]/60 p-5 text-center transition-colors hover:border-blue-500/30">
          ...
          <span className="font-display text-3xl sm:text-4xl font-bold text-white">
            {loadTime} <span className="text-xs text-blue-400">sec</span>
          </span>
          <span className="block text-[10px] text-white/40 mt-1">
        ...
        <div className="rounded-2xl border border-blue-500/30 bg-blue-500/10 p-5 text-center">
          <div className="flex items-center justify-center gap-1.5 text-xs text-blue-300 mb-2 font-medium">
            <TrendingUp className="h-3.5 w-3.5 text-blue-400" />
            <span>Conversion Lift</span>
          </div>
          <span className="font-display text-3xl sm:text-4xl font-bold text-blue-300">
            +{conversionLift}%
          </span>
          <span className="block text-[10px] text-blue-300/70 mt-1 font-mono">
