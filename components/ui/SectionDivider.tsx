...
export default function SectionDivider() {
  return (
    <div className="relative my-12 flex w-full items-center justify-center overflow-hidden py-4">
      ...
      <div className="h-px w-full max-w-[1360px] bg-gradient-to-r from-transparent via-white/15 to-transparent" />

      {/* Animated traveling light beam */}
      <motion.div
        className="absolute h-[1.5px] w-48 bg-gradient-to-r from-transparent via-cyan-400 to-transparent blur-[1px]"
        animate={{
          x: ["-100%", "100%"],
        }}
        transition={{
